...
| --- | ---: | --- |
| Pruebas ejecutadas | 289 | Resultado de `pnpm test` (pnpm test:counts) |
| Pruebas: @garfit/api | 131 | Resultado de `pnpm test` para ese paquete |
| Pruebas: @garfit/api-client | 19 | Resultado de `pnpm test` para ese paquete |
| Pruebas: @garfit/domain | 76 | Resultado de `pnpm test` para ese paquete |
...
| Movimientos del catalogo | 1319 | packages/movements/data/catalog.json |
| Aplicaciones | 4 | Directorios de apps/ |
